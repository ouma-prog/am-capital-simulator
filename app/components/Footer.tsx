  ...
  return (
    <footer className="bg-[#003049] text-white mt-16">
      <div className="mx-auto max-w-7xl px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          <Image
            src="/images/logoAM.png"   // ✅ ton logo dans public/images
            alt="A&M Capital"
            width={260}
            height={140}
            priority
        ...
        <nav aria-label="Liens de pied de page">
          <ul className="space-y-2">
            <li>
              <a href="/#simulation" className="hover:text-[var(--color-am-gold)]">Simulation</a>
            </li>
            <li>
              <a href="#contact" className="hover:text-[var(--color-am-gold)]">Contact</a>
            </li>
          </ul>
        </nav>
